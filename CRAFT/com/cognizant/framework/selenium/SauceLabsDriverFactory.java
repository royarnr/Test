...
public class SauceLabsDriverFactory {
	 ...
	 * 
	 * @param platformName
	 *            The platform to be used for the test execution (Windows,
	 *            Mac, etc.)
	 * @param version
	...
	public static WebDriver getSauceRemoteWebDriver(String sauceURL,
			Browser browser,String browserVersion,Platform platformName,SeleniumTestParameters testParameters) {
